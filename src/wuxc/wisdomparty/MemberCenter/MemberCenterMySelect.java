...
public class MemberCenterMySelect extends Activity implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.member_center_myselect);
		initview();
		setonclicklistener();
		setheadtextview();
		getdatalist(curPage);
