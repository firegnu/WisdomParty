...
public class MemberCenterMyPublishDetail extends Activity implements OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.membercentermypublishdetail);
