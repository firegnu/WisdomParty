...
public class MemberCenterMyVote extends Activity implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.member_center_myvote);
		initview();
		setonclicklistener();
		setheadtextview();
		getdatalist(curPage);
	...
	private void getdatalist(int arg) {
		...
		try {
			...
			for (int i = 0; i < 10; i++) {
				...
				listinfo.setMoney("李默");
				listinfo.setMonth("某种投票");
