...
public class MemberCenterMyReward extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.member_center_myreward);
	...
	private void initfragment() {
		...
		Fragments.add(new MyPunishFragment());
	}
