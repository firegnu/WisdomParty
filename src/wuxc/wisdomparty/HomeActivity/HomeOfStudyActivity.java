...
import wuxc.wisdomparty.HomeOfYouth.AppearanceOfMember;
import wuxc.wisdomparty.HomeOfYouth.DynamicActivity;
...
public class HomeOfStudyActivity extends FragmentActivity
	...
	private void initviewHeight() {
		...
		// (android.widget.LinearLayout.LayoutParams) RelativeViewPage
		// .getLayoutParams();
