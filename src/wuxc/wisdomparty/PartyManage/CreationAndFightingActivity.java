...
public class CreationAndFightingActivity extends Activity implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.creation_and_fighting_activity);
		initview();
		setonclicklistener();
		setheadtextview();
		getdatalist(curPage);
