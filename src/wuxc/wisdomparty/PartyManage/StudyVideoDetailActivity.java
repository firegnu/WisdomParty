...
public class StudyVideoDetailActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.study_video_detail_activity);
		initview();
		setonclicklistener();
		setlayoutheight();
		...
		TimeLong = bundle.getString("TimeLong");
		settext();
		ShowCollectAndGreat();
	}
	...
	private void initview() {
		...
		TextResource = (TextView) findViewById(R.id.text_resource);
		TextDetail = (TextView) findViewById(R.id.text_detail);
		LinCollect = (LinearLayout) findViewById(R.id.lin_collect);
		LinGreat = (LinearLayout) findViewById(R.id.lin_great);
		RelaBackGround = (RelativeLayout) findViewById(R.id.rela_back);
		TextTitle = (TextView) findViewById(R.id.text_title);
		TextTimeLong = (TextView) findViewById(R.id.text_timelong);
	}

	private void setonclicklistener() {
		// TODO Auto-generated method stub
		RelaBackGround.setOnClickListener(this);
	...
	private void setlayoutheight() {
		...
		RelativeLayout.LayoutParams layoutParams1 = (android.widget.RelativeLayout.LayoutParams) ImageBackground
				.getLayoutParams();
		layoutParams1.height = height;
		ImageBackground.setLayoutParams(layoutParams1);
		LinearLayout.LayoutParams layoutParams = (android.widget.LinearLayout.LayoutParams) RelaBackGround
				.getLayoutParams();
		layoutParams.height = height;
		RelaBackGround.setLayoutParams(layoutParams);
	}
	...
	private void ShareDialog() {
		...
		builder.setQQImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				Tag = "QQ好友";
				if (image == null) {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.QQ)
		...
		builder.setQQZoneImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.QZONE)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.QZONE)
		...
		builder.setWeChatImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN)
		...
		builder.setWeFriendsImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(StudyVideoDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
