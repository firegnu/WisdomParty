...
public class AppeaeanceOfVipDetail extends Activity implements OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.appearanceofvipdetail);
	...
	private void ShareDialog() {
		...
		// R.drawable.qidongye);
		// } else {
		image = new UMImage(AppeaeanceOfVipDetail.this, R.drawable.image_share);
		// }
		...
		builder.setQQImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				Tag = "QQ好友";
				if (image == null) {
					new ShareAction(AppeaeanceOfVipDetail.this).setPlatform(SHARE_MEDIA.QQ).setCallback(umShareListener)
		...
		builder.setQQZoneImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(AppeaeanceOfVipDetail.this).setPlatform(SHARE_MEDIA.QZONE)
		...
		builder.setWeChatImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(AppeaeanceOfVipDetail.this).setPlatform(SHARE_MEDIA.WEIXIN)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(AppeaeanceOfVipDetail.this).setPlatform(SHARE_MEDIA.WEIXIN)
		...
		builder.setWeFriendsImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(AppeaeanceOfVipDetail.this).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(AppeaeanceOfVipDetail.this).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
