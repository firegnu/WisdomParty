...
public class MemberRulesActivity extends Activity implements OnTouchListener, OnClickListener, OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.member_rules_activity);
		initview();
		setonclicklistener();
		setheadtextview();
		getdatalist(curPage);
	...
	private void getdatalist(int arg) {
		...
		try {
			...
			for (int i = 0; i < 10; i++) {
				...
				listinfo.setTitle("中共十八大习近平总书记的讲话规则" + arg);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		intent.setClass(getApplicationContext(), RulesDetailActivity.class);
