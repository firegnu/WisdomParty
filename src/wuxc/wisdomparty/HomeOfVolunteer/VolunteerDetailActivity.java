...
public class VolunteerDetailActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.volunteerdetailactivity);
		initview();
		setonclicklistener();
		setlayout();
	...
	private void ShareDialog() {
		...
		// R.drawable.qidongye);
		// } else {
		image = new UMImage(VolunteerDetailActivity.this, R.drawable.image_share);
		// }
		...
		builder.setQQImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				Tag = "QQ好友";
				if (image == null) {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.QQ)
		...
		builder.setQQZoneImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.QZONE)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.QZONE)
		...
		builder.setWeChatImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN)
		...
		builder.setWeFriendsImage(new android.content.DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				if (image == null) {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
							.setCallback(umShareListener).withText(content).withTitle(title).withTargetUrl(targeturl)
							.share();
				} else {
					new ShareAction(VolunteerDetailActivity.this).setPlatform(SHARE_MEDIA.WEIXIN_CIRCLE)
