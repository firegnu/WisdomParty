...
public class dialogtwo extends Dialog {
	...
	public dialogtwo(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public dialogtwo create() {
			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final dialogtwo dialog = new dialogtwo(context, R.style.Dialog);
			final View layout = inflater.inflate(R.layout.dialog_two, null);
