...
import wuxc.wisdomparty.Cache.AssistanceCache;
...
public class AssistanceAdapter extends ArrayAdapter<AssistanceModel> {
	...
	public AssistanceAdapter(Activity activity, List<AssistanceModel> imageAndTexts, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		AssistanceCache viewCache;
		if (rowView == null) {
			LayoutInflater inflater = activity.getLayoutInflater();
			rowView = inflater.inflate(R.layout.item_assistance, null);
			viewCache = new AssistanceCache(rowView);
			rowView.setTag(viewCache);
		} else {
			viewCache = (AssistanceCache) rowView.getTag();
		}
		AssistanceModel imageAndText = getItem(position);
